...
CATEGORY_PROMPTS: Dict[ClothingCategory, List[str]] = {
    ClothingCategory.top: [
        "a product photo of a shirt worn on the upper body",
        "a product photo of a t-shirt for the chest and arms",
        "a product photo of a blouse upper garment",
        "a product photo of a sweater worn above the waist",
        "a product photo of a top covering only the upper body",
    ],
    ClothingCategory.bottom: [
        "a product photo of jeans denim pants for the legs",
        "a product photo of trousers worn below the waist",
        "a product photo of shorts for the lower body",
        "a product photo of a skirt worn from waist down",
        "a product photo of pants covering only the legs",
    ],
    ClothingCategory.dress: [
        "a product photo of a dress covering both chest and legs",
        "a product photo of a one-piece dress from shoulders to knees",
        "a product photo of a jumpsuit covering the whole body",
        "a product photo of a full body dress with bodice and skirt",
        "a product photo of a romper covering top and bottom together",
    ],
    ClothingCategory.shoes: [
        "a product photo of sneakers footwear",
        "a product photo of boots for feet",
        "a product photo of heels shoes",
        "a product photo of sandals footwear",
        "a product photo of shoes worn on feet",
    ],
    ClothingCategory.outerwear: [
        "a product photo of a jacket worn over clothes",
        "a product photo of a coat outerwear",
        "a product photo of a blazer outer layer",
        "a product photo of a hoodie with zipper",
        "a product photo of outerwear worn on top of outfit",
    ],
    ClothingCategory.accessory: [
        "a product photo of a handbag or purse",
        "a product photo of a hat or cap",
        "a product photo of a belt accessory",
        "a product photo of a scarf neckwear",
        "a product photo of a fashion accessory",
    ],
}
